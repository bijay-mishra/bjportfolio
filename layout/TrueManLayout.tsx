...
const TrueManLayout: React.FC<TrueManLayoutProps> = ({ children, noSidebar, onePage }) => {
  useEffect(() => {
  ...
  useEffect(() => {
    Fancybox.bind("[data-fancybox]", {
      animationEffect: "zoom-in-out", // Add only if supported
      animationDuration: 600,
      transitionDuration: 1200,
      buttons: ["zoom", "slideshow", "thumbs", "close"],
    } as any); // Cast to any to suppress TypeScript errors
